...
relative_dataset_dir = '../../../data/processed/combinedv6'
...
def download_training_data():
    download_to_folder('train_images.zip', 'http://cloud.dk-s.de/datasets/combinedv6/train_images.zip')

def download_training_labels():
    download_to_folder('train_labels.zip', 'http://cloud.dk-s.de/datasets/combinedv6/train_labels.zip')

def download_validation_data():
    download_to_folder('val_images.zip', 'http://cloud.dk-s.de/datasets/combinedv6/val_images.zip')

def download_validation_labels():
    download_to_folder('val_labels.zip', 'http://cloud.dk-s.de/datasets/combinedv6/val_labels.zip')
