...
relative_dataset_dir = '../../../data/processed/combinedv8'
...
def download_training_data():
    download_to_folder('train_images.zip', 'http://cloud.dk-s.de/datasets/combinedv8/train_images.zip')

def download_training_labels():
    download_to_folder('train_labels.zip', 'http://cloud.dk-s.de/datasets/combinedv8/train_labels.zip')

def download_validation_data():
    download_to_folder('val_images.zip', 'http://cloud.dk-s.de/datasets/combinedv8/val_images.zip')

def download_validation_labels():
    download_to_folder('val_labels.zip', 'http://cloud.dk-s.de/datasets/combinedv8/val_labels.zip')
